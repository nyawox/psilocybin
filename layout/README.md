...
Designed for row stagger, with slides and magic keys in mind.  
...
Magic rules effectively reduces bad patterns, such as SFBs and SFS to almost 0 percent.  
They also reduces keystrokes with word-builder rules, increasing efficiency.
